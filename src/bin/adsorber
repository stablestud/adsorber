...
showHelp()
{
        ...
        echo "  revert  - reverts the hosts file to the last applied host file."
...
showSpecificHelp()
{
        case "${operation}" in
                install )
                        ...
                        echo " - install a scheduler which updates your hosts file with ad-domains"
                        echo "   once a week. (either systemd, cronjob or none)"
                        echo " - install the newest ad-domains in your hosts file."
                ...
                restore )
                        ...
                        echo
                        echo "Important: If you have a scheduler installed it'll re-apply ad-domains to your hosts"
                ...
                revert )
                        ...
                        echo
                        echo "To revert to the last applied hosts file."
                        echo "Good use if the current host file has been corruptea or misses some ad-domains."
                        echo
                        echo "The command will:"
